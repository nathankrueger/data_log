...
def detect_display(image_path, min_area=5000, max_area_ratio=0.05):
    ...
    Returns list of bounding boxes (x, y, w, h) sorted by score (best first).
    """
...
def run_ocr(image_path, crop_region):
    ...
    gray_path = image_path.parent / "ocr_gray.png"
    cv2.imwrite(str(gray_path), gray)
    print(f"Grayscale crop saved to: {gray_path}")
    ...
    try:
        ...
        print(f"ssocr could not recognize digits (stderr: {result.stderr.strip()})")
        return None
            ...
            if args.crop:
                ...
                if len(crop_region) != 4:
                    ...
                    if args.debug_detect:
                        ...
                        cv2.putText(debug_img, "manual", (x, y-10),
                ...
                if args.debug_detect:
                    ...
                    for i, (x, y, w, h) in enumerate(candidates):
                        ...
                        cv2.putText(debug_img, f"#{i+1}", (x, y-10),
                ...
                if candidates:
                    crop_region = candidates[0]  # Use largest candidate
